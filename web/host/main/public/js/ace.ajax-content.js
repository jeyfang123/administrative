			...
			.done(function(result) {
				...
				if(typeof update_active === 'function') {
					...
					if(link_element.length > 0) {
						var nav = link_element.closest('ul#side-menu');
						if(nav.length > 0) {
							...
							var active_li = link_element.addClass('active');
							var active_li = link_element.closest('li.menu').find("a.waves-effect").addClass('active');;
